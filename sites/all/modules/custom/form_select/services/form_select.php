  ...
  <form method="post" id="donateform" action="/sites/all/modules/custom/form_select/services/procesar_datos.php">
    ...
    <form id="donateform" action="">
        ...
        <fieldset>
            <div class="form-group">
                ...
                <input class="form-control value"  type="text" name="valor" id="valor" autocomplete="off"  placeholder="Monto en pesos colombianos" tabindex="4"/>
            ...
            <div class="form-group form-select">
                ...
                <select class="form-control" name="designacion" id="designacion" required="" tabindex="5">
                    ...
                    <option value="PE20@SEQESFININ" >Quiero Estudiar Ingeniería</option>
                    ...
                    <option value="PE20@SEHYEGENHY" >Fondo Henry Yerly</option>
                    ...
                    <option value="AF17@FASPRDCPCV" >Congreso Visible Donaciones</option>
                    <option value="PI20@FASPRFECLT" >Liberando tiempo: Mujeres y Lavadoras</option>
                    <option value="AF17@FASPRFDEPP" > Proyecto Paiis</option>
                </select>
            </div>
            <?php 
        }
    ...
    <fieldset>
        <div class="form-group form-select">
            ...
            <select class="form-control" name="tipoDocumentoIdentificacion" id="tipoDocumentoIdentificacion" required="" tabindex="9" autofocus="">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="documentoIdentificacion" id="documento" placeholder="Numero de identificación" required="" tabindex="10" aria-required="true">
        </div>


        <div class="form-group">
            <label>Dirección</label>
            <input class="form-control" type="text" name="direccionCorrespondencia" id="don_address" placeholder="Dirección" required="" tabindex="11"/>
        </div>


        <div class="form-group">
            <label>Teléfono</label>
            <input class="form-control" type="number" name="telefono" id="don_phone" placeholder="Teléfono" required="" tabindex="12"/>
        </div>

        <div class="form-group">
            <label>Celular</label>
            <input class="form-control" type="number" name="telefonoMovil" id="don_mobie" placeholder="Celular" required="" tabindex="13"/>
        </div>

        <div class="form-group">
            <label for="comments">Comentarios</label>
            <textarea class="form-control" name="comentarios" id="don_comments" rows="1" tabindex="14" placeholder="Escribe aquí tus comentarios"></textarea>
        </div>

        <div class="form-group">
            <label>Nombres</label>
            <input class="form-control" type="text" name="nombreComprador" id="nombres" placeholder="Nombres" required="" tabindex="15"/>
        </div>

        <div class="form-group">
            <label>Apellidos</label>
            <input class="form-control" type="text" name="apellidoComprador" id="apellidos" placeholder="Apellidos" required="" tabindex="16"/>
        </div>

        <div class="form-group">
            <label>Email</label>
            <input class="form-control" type="email" name="emailComprador" id="correo" placeholder="Email" required="" tabindex="17"/>
        </div>

        <div class="form-group form-select">
            <label>País</label>
            <select class="form-control" name="pais" id="don_country" required="" tabindex="18">
        ...
        <div class="form-group form-select">
            ...
            <select class="form-control" name="estado" id="don_depto" required="" tabindex="19">
        ...
        <div class="form-group form-select">
            <label>Ciudad</label>
            <select class="form-control" name="ciudadCorrespondencia" id="don_city" required="" tabindex="20">
                <option value="" hidden disabled selected>Ciudad</option>

            </select>
            <input class="form-control" type="text" name="ciudad" id="ciudadLiteral" value="BOGOTA D.C." required="" tabindex="21">
        </div>
