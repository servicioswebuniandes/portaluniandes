...
var stickyOffset1 = jQuery('.navbar-default').offset().top;

jQuery(window).scroll(function(){
	var sticky = jQuery('.btn-volver'),
	scroll = jQuery(window).scrollTop();

	if (scroll > stickyOffset1) sticky.addClass('fixed_back');
	else sticky.removeClass('fixed_back');
});
