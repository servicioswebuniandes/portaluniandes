...
<section class="btn-block line-blue">
	<a href="<?php print $url_idioma ?>" class="btn-default btn-border-blue btn-featured_events"><?php print t( "View more important events" )?></a>
</section>
